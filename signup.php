...
if (isset($_POST["signup"])) {
	...
	if (count($errors) === 0) {
		$insert_data = "INSERT INTO users (username, fullname, email, password) values('$username', '$fullname', '$email', '$epassword')";
			...
			<div class="center">
				<div class="login">
					...
					<main>
						...
						<br>
						<a href="encoded_image.png" id="downloadLink" download="encoded_image.png" class="btn btn-primary btn-block">Download</a>
					</main>
				</div>
			</div>
		</div>
