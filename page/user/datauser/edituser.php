<?php
require "koneksi.php";
$user = mysqli_real_escape_string($koneksi, $_COOKIE['user']);
			...
			<div class="table-responsive">
				<div class="body">
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<div class="form-line">
								<input name="password" value="<?php echo $fetch['password']; ?>" class="form-control" />
							</div>
						</div>
					...
					if (isset($_POST["simpan"])) {
						...
						$update_data = "UPDATE users SET fullname='$fullname', email='$email', password='$password' WHERE username='$username'";
