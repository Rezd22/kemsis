				...
				<div class="body">
					...
					<?php
						...
						if(isset($_POST["simpan"])){
							...
							$user_check = "SELECT * FROM admin WHERE username = '$username'";
							$res = mysqli_query($koneksi, $user_check);
							$insert_data = "INSERT INTO admin (username, fullname, email, password) values('$username', '$fullname', '$email', '$password')";
